...
export default function AvisoLegal() {
  return (
    <div className="container py-12 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold mb-6 text-nutr-green-600">Aviso Legal</h1>
      
      <section className="mb-8">
        <p className="mb-4">
          CRISTINA GONZÁLEZ, responsable del sitio web, en adelante RESPONSABLE, pone a disposición de los usuarios el presente documento, con el que pretende dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSICE), así como informar a todos los usuarios del sitio web respecto a cuáles son las condiciones de uso.
        </p>
        <p className="mb-4">
          Toda persona que acceda a este sitio web asume el papel de usuario, comprometiéndose a la observancia y cumplimiento riguroso de las disposiciones aquí dispuestas, así como a cualquier otra disposición legal que fuera de aplicación. 
        </p>
        <p>
          CRISTINA GONZÁLEZ se reserva el derecho de modificar cualquier tipo de información que pudiera aparecer en el sitio web, sin que exista obligación de preavisar o poner en conocimiento de los usuarios dichas obligaciones, entendiéndose como suficiente con la publicación en el sitio web de CRISTINA GONZÁLEZ
        </p>
      </section>

      <section className="mb-8">
        <h2 className="text-xl font-medium mb-4 text-nutr-green-500">1. DATOS IDENTIFICATIVOS</h2>
        <p className="mb-2"><strong>Denominación social:</strong> CRISTINA GONZÁLEZ</p>
        <p className="mb-2"><strong>Nombre comercial:</strong> NUTREMOTION</p>
        <p className="mb-2"><strong>CIF:</strong> 47066324-K</p>
        <p className="mb-2"><strong>Domicilio:</strong> Plaza de Honduras 26 – bajo</p>
        <p><strong>e-mail:</strong> info@nutremotion.com</p>
      </section>

      <section className="mb-8">
        <h2 className="text-xl font-medium mb-4 text-nutr-green-500">2. OBJETO</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-medium mb-4 text-nutr-green-500">3. PRIVACIDAD Y TRATAMIENTO DE DATOS</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-medium mb-4 text-nutr-green-500">4. PROPIEDAD INDUSTRIAL E INTELECTUAL</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-medium mb-4 text-nutr-green-500">5. OBLIGACIONES Y RESPONSABILIDADES DEL USUARIO DEL ESPACIO WEB</h2>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-medium mb-4 text-nutr-green-500">6. RESPONSABILIDADES</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-medium mb-4 text-nutr-green-500">7. HIPERVÍNCULOS</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-medium mb-4 text-nutr-green-500">8. PROTECCIÓN DE DATOS</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-medium mb-4 text-nutr-green-500">9. COOKIES</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-medium mb-4 text-nutr-green-500">10. DECLARACIONES Y GARANTÍAS</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-medium mb-4 text-nutr-green-500">11. FUERZA MAYOR</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-medium mb-4 text-nutr-green-500">12. RESOLUCIÓN DE CONTROVERSIAS. LEY APLICABLE Y JURISDICCIÓN</h2>
        <p className="mb-4">
      ...
      <div className="mt-8">
        <Link to="/" className="text-nutr-green-600 hover:text-nutr-green-700 font-medium">
