...
// Using the same program data as in Services.tsx
const programas = [
  {
...

  {
    ...
    description: "Plan dietético personalizado con estrategias adaptadas para aplicar el ayuno intermitente de forma segura y eficaz, ajustado a tus horarios, objetivos y preferencias.",
    features: [
    ...
    <div className="py-12">
      <div className="container px-4 md:px-6">
        <div className="text-center mb-12">
          <h1 className="font-serif text-4xl md:text-5xl font-bold mb-4 text-nutr-gray-800">Nuestros Programas</h1>
        ...
        <div className="mt-16 text-center">
          <p className="text-xl font-medium text-nutr-gray-800 mb-6">¿No estás seguro de qué programa elegir?</p>
          <Button asChild className="bg-nutr-purple-600 hover:bg-nutr-purple-700">
            <Link to="/contacto">Contáctanos y te ayudaremos</Link>
          </Button>
        </div>
      </div>
    </div>
